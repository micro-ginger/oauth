...
func (a *App[acc, regReq, reg]) initializeServer() {
	a.initializeGinger()
	a.initializeAuthenticator()
}

func (a *App[acc, regReq, reg]) initializeGinger() {
...
func (a *App[acc, regReq, reg]) initializeGrpc() {
...
func (a *App[acc, regReq, reg]) initializeAuthenticator() {
