...
func (a *App[acc, prof, regReq, reg]) initializeDatabases() {
	a.initializeSql()
	a.initializeRedis()
	a.initializeCache()
}

func (a *App[acc, prof, regReq, reg]) initializeSql() {
...
func (a *App[acc, prof, regReq, reg]) initializeRedis() {
...
func (a *App[acc, prof, regReq, reg]) initializeCache() {
