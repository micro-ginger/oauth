...
(
    ...
    constraint role_scopes_roles_id_fk
        foreign key (role_id) references roles (id),
    constraint role_scopes_scopes_id_fk
...
(
    ...
    constraint account_roles_roles_id_fk
        foreign key (role_id) references roles (id),
...
(
    ...
    scope_id      bigint unsigned not null,
    is_authorized bool            null,
    constraint account_scopes_account_id_fk
        foreign key (account_id) references accounts (id),
    constraint account_scopes_scopes_id_fk
        foreign key (scope_id) references scopes (id),
